...
class Search {
    constructor() {
        this.addSearchHTML() // need to be on the beginner
    ...
    getResults() {
        ...
        // this.isSpinnerVisible = false
        // $.getJSON('http://localhost:3000/Amazing-University/wp-json/wp/v2/posts?search=' + this.searchField.val(), posts => {
        // $.when(
        ...
        //     this.resultsDiv.html(`
        //         <h2 class="search-overlay__section-title">Genereal Information</h2>
