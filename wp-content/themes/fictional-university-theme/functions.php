...
function university_files() {
    wp_enqueue_script('google-map', '//maps.googleapis.com/maps/api/js?key=AIzaSyDgGUug9Ho6MKMYTJYxH_IYDn1BLy5IENc', NULL, 1.0, true);
...
function universityMapKey($api) {
    $api['key'] = 'AIzaSyDgGUug9Ho6MKMYTJYxH_IYDn1BLy5IENc';//'AIzaSyDgGUug9Ho6MKMYTJYxH_IYDn1BLy5IENc';
    return $api;
}

add_filter('acf/fields/google_map/api', 'universityMapKey');

// redirect subscribes accounts out of admin and onto homepage
...
add_filter('wp_insert_post_data', 'makeNotePrivate', 10, 2); //this 2 is about how many parameters the function have. This 10 is just the priority that the function will run
